...
def start(message):
  bot.reply_to(message, "Hello! I'm the virtual Telegram assistant for the 3 TPT BN DOO! You may use the topics found in /help to retrieve the necessary template from me.")
