...
def nvci(message):
  bot.reply_to(message, "Incident Reporting \n\n*From / Category of Incident / Type of Training*:\n3 Tpt Bn, (Coy/Node) / Non-Training related\n\n*1. Nature of Activity:*\n NCVI/ CVI \n\n*2. Date & Time of Incident:*\nDDMMYY, HHMMhrs\n\n*3. Location of the Incident:*\nCamp/Location:\nArea:\n\n*4. Vehicles Involved:*\n\n*5. Rank & Full name of Serviceman involved:*\n\n*6. PES:*\n\n*7. Brief Description of the Incident:*\nOn DDMMYY at HHMMhrs, (Name of TO) was driving in (Location of Camp) for (Purpose). He was executing (Details) and came into contact with (Object/Vehicle that came into contact). Vehicle suffered (details of damage to vehicle). (Object/Vehicle that came into contact) was seen to sustain (details of damages)\n\n(If any) injuries to personnel.\n\n*8. IVC Footage:*\nTo be extracted\n\n*9. IVD Data:*\nTo be extracted\n\n*10. Maint Record:*\n1)Last UQM Date:\n2)Next UQM Date:\n3)Last AVI Date:\n4)Next AVI Date:\n\n*11. Reportings:*\nIHQ:\nGSOC:\nAIMSIS:\nIncident Case Report No:\n\n*12. Reported by:*\n", parse_mode='Markdown')
...
def cont(message):
  bot.reply_to(message, "*3 TPT DOO Phone*: 8940 8249 \n*SBC Guardroom*: 6796 4358\n*SBMC*: 6796 4402\n*IHQ*: 6307 4506\n*GSOC*: 6768 4844\n*CTN*: 6544 4567\n*TTN*: 6864 2909\n*CLN*: 6559 7877", parse_mode='Markdown')
